...
public class Pvertex {
	...
	public Map<Pvertex, List<Double>>  GetOutEdgeIterator()
	{
		return null;
	}
	...
	void SendMessageTo(Set<Pvertex> targets,double Message )
	{
		for(Pvertex v:targets)
		{
			v.ranks.add(Message);
		}
	} 
